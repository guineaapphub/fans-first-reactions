      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr]">
          <div className="space-y-5 text-left">
            ...
            <p className="max-w-3xl leading-relaxed">
              Fans First Reactions is an independent football creator directory
              that helps supporters discover football content creators and
              communities from across clubs and leagues.
            </p>
        ...
        <div className="mt-8 border-t border-white/10 pt-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-4xl leading-relaxed">
            The independent football creator directory. Maintained by Fans First
            Reactions. Built with the football community.
          </p>
